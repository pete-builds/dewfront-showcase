...
**The card asks the question only while the answer can change.** "Should I open the windows" is worth a card when the dew point or the heat is deciding at least one hour of the next twenty-four. When nothing in the air is deciding anything, it collapses to a line: "dry air all week" with tonight's rain or cold beneath it, or "AC season" with the next hour worth opening up for. When every hour is cold it switches to the question that is live in that season and that the same dew point already predicts: whether the house is too dry. It reports what the outside air becomes once heated indoors, what to aim a humidifier at, and the humidity above which the windows start sweating, that last figure taken from published glass guidance rather than derived, because a derivation from centre-of-glass physics reads five to fifteen points high and condensation starts at the cold edge.

The switch is judged over a day rather than an hour, and that timescale was measured rather than assumed. Deciding on the current hour flipped the card's shape 48 times across an Ithaca October, on 24 of 32 days, because both thresholds cross every afternoon in the shoulder season. Over the next 24 hours it changes seven times in the same month, and never in a Minneapolis January.
